...
public class RequestNotiConsumer {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    private final NotificationRepository notificationRepository;

    @KafkaListener(topics = "${kafka.request-noti-topic}", groupId = "${kafka.group-noti-id}", containerFactory = "notiListenerContainerFactory")
